        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              <img src="/images/qrs_logo.png" alt="QRS Logo" className="w-8 h-8 mr-2" />
              <span className="font-bold text-xl">QRS</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Quantum-resistant security solutions for the future of digital protection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@qrs.com" className="text-gray-400 hover:text-white transition-colors">info@qrs.com</a>
              </li>
              <li className="flex items-center">
